	...
	elseif(event == "GOSSIP_SHOW") then
		...
		for i=1, getn(GossipOptions) do
			...
			elseif (GossipOptions[i] == "trainer" and dsc == "Reset my talents.") then
				gossipbreak = false
			elseif ((GossipOptions[i] == "trainer" and processgossip) or (GossipOptions[i] == "vendor" and processgossip) or (GossipOptions[i] == "battlemaster" and (LPCONFIG.QBG or processgossip)) or (GossipOptions[i] == "gossip" and processgossip) or (GossipOptions[i] == "petition" and processgossip) or IsShiftKeyDown() or (string.find(dsc, "Teleport me to the Molten Core") and processgossip)) then
				gossipnr = i
